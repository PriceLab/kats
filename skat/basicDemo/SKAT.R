...
# 1) test for associations between SNP sets and continuous/binary phenotypes with
#    adjusting for covariates and kinships and
# 2) to compute power/sample size for future studies.
